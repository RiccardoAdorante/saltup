...
def test_preprocess(yolo_nas_with_temp_model):
    ...
    processed_image = yolo_nas_with_temp_model.preprocess(image, target_height, target_width)
...
def test_postprocess(yolo_nas_with_temp_model):
    ...
    # Combine into a list
    raw_output = [bboxes, scores]
    
    # Define image dimensions
    image_height, image_width = 480, 640
    
    # Postprocess the raw output
    result = yolo_nas_with_temp_model.postprocess(raw_output, image_height, image_width)
